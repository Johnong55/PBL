...
public class Controller_Teacher implements Action {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == viewteacher.buttonHome) {
			...
			// lưu kì thi
			if (viewteacher.LuuExam()) {
				JOptionPane.showMessageDialog(null, "Tạo kì thi thành công", "Thông báo",
			...
			if (viewteacher.CapNhatExam()) {
				JOptionPane.showMessageDialog(null, "Cập nhật kì thi thành công", "Thông báo",
						JOptionPane.INFORMATION_MESSAGE);
			} else {
				JOptionPane.showMessageDialog(null, "Cập nhật kì thi thất bại", "Thông báo",
						JOptionPane.INFORMATION_MESSAGE);
			}
			this.viewteacher.ViewExam();
