...
public class Demo {
	public static void main(String[] args) {
		 ...
		 * Class(); cl1.setIdclass("01"); cl1.setTenlop("10A"); cl1.setTruong(truong1);
		 * Class cl2 = new Class(); cl2.setIdclass("02"); cl2.setTenlop("10B");
		 ...
		 * sv1.setUsername(sv1.getId()); sv1.setPassword(sv1.getId());
		 * sv1.setMaquyen(2); sv1.setTen("Ong Van Quang Tri"); Sv sv2 = new Sv();
		 * sv2.setId("102220089"); sv2.setUsername(sv2.getId());
		 * sv2.setPassword(sv2.getId()); sv2.setMaquyen(2);
		 * sv2.setTen("Nguyen Thanh Vinh"); Sv sv3 = new Sv(); sv3.setId("102220090");
		 * sv3.setUsername(sv3.getId()); sv3.setPassword(sv3.getId());
		 * sv3.setMaquyen(2); sv3.setTen("Tran Dang Minh Duc"); Sv sv4 = new Sv();
		 * sv4.setId("102220091"); sv4.setUsername(sv4.getId());
		 * sv4.setPassword(sv4.getId()); sv4.setMaquyen(2); sv4.setTen("Le Khiet Dan");
		 * 
		 * Sv sv5 = new Sv(); sv5.setId("102220092"); sv5.setUsername(sv5.getId());
		 * sv5.setPassword(sv5.getId()); sv5.setMaquyen(2);
		 * sv5.setTen("Nguyen Quang Truong"); sv4.setIdclass(cl3); sv2.setIdclass(cl2);
		 ...
		 * nhdao.insert(nh); Cauhoi q1 = new Cauhoi("q1",
		 * "What is the capital of France?", "Paris", "London", "Berlin", "Madrid", 2,
		 * 1, nh1); Cauhoi q2 = new Cauhoi("q2", "Who wrote 'Romeo and Juliet'?",
		 * "William Shakespeare", "Jane Austen", "Charles Dickens", "Mark Twain", 1, 1,
		 * nh); Cauhoi q3 = new Cauhoi("q3", "What is the chemical symbol for water?",
		 * "H2O", "CO2", "O2", "NaCl", 1, 1, nh); Cauhoi q4 = new Cauhoi("q4",
		 * "Which planet is known as the Red Planet?", "Mars", "Venus", "Jupiter",
		 * "Saturn", 1, 1, nh1); Cauhoi q5 = new Cauhoi("q5",
		 * "Who painted the Mona Lisa?", "Leonardo da Vinci", "Vincent van Gogh",
		 * "Pablo Picasso", "Claude Monet", 1, 1, nh); Cauhoi q6 = new Cauhoi("q6",
		 * "What year did the Titanic sink?", "1912", "1905", "1920", "1935", 1, 1,
		 * nh1); Cauhoi q7 = new Cauhoi("q7",
		 * "What is the tallest mountain in the world?", "Mount Everest",
		 * "Mount Kilimanjaro", "K2", "Mount Fuji", 1, 1, nh); Cauhoi q8 = new
		 * Cauhoi("q8", "Who invented the telephone?", "Alexander Graham Bell",
		 * "Thomas Edison", "Nikola Tesla", "Guglielmo Marconi", 1, 1, nh); Cauhoi q9 =
		 * new Cauhoi("q9", "What is the currency of Japan?", "Yen", "Euro", "Dollar",
		 * "Pound", 1, 1, nh1); Cauhoi q10 = new Cauhoi("q10",
		 * "Who is the author of 'To Kill a Mockingbird'?", "Harper Lee",
		 * "J.K. Rowling", "Stephen King", "Ernest Hemingway", 1, 1, nh1);
		 * CHdao.insert(q10); CHdao.insert(q1); CHdao.insert(q2); CHdao.insert(q3);
		 * CHdao.insert(q4); CHdao.insert(q5); CHdao.insert(q6); CHdao.insert(q7);
		 * CHdao.insert(q8); CHdao.insert(q9); DeThi dethi1 = new DeThi();
		 * dethi1.addCauhoi(q10); dethi1.addCauhoi(q2); dethi1.addCauhoi(q3);
		 * dethi1.setId("05"); dethi1.setKithi(kithi2);
		 * 
